...
-   **/core**: Houses the central logic of the application. This includes loading the `git-hooks.config.ts` configuration, finding and executing the corresponding npm scripts, and managing the hook execution process (e.g., parallel execution).
